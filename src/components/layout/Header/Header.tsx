...
export function Header() {
  ...
  return (
    <header className="grid fixed top-0 left-0 z-50 grid-cols-3 items-start w-full p-sides md:grid-cols-12 md:gap-sides">
      ...
      <Link href="/" className="md:col-span-3 xl:col-span-3 break-keep" prefetch>
        <p className="text-3xl font-bold shrink-0">©THUNDER K</p>
        {/* <LogoSvg className="w-auto h-6 max-md:place-self-center md:w-full md:h-auto max-w-96" /> */}
      </Link>
      <nav className="flex gap-2 justify-end items-center md:col-span-9 xl:col-span-9">
